...
const Hero = ({ onEmiratEstateGPTClick }) => { // Added onEmiratEstateGPTClick prop
  ...
  return (
    <AnimatedContainer distance={50} direction="vertical">
      <div className="mt-20">
        {/* Adjusted margin for the entire hero section container: my-3 mx-6 changed to my-8 mx-10 */}
        {/* Further increased top/bottom and left/right margins for the image container */}
        <div className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 my-12 mx-16">
          {/* Background Image */}
          <motion.div
            initial={{ opacity: 0, scale: 1.1 }} // Added initial scale for zoom-out effect
            animate={{ opacity: 1, scale: 1 }}    // Animate to normal scale
            transition={{ duration: 1.5, ease: "easeInOut" }} // Adjusted transition
            className="absolute inset-0 z-0 rounded-2xl overflow-hidden"
            style={{
              backgroundImage: `url(${golfHeroImage})`, // Changed to use golfHeroImage
              backgroundSize: "cover",
              backgroundPosition: "center",
            }}
          >
            <div className="absolute inset-0 bg-gradient-to-t from-orange-300/40 via-slate/10 to-transparent" />
          </motion.div>
          ...
          <div className="relative z-10 max-w-7xl mx-auto text-center">
            ...
            >
              <h1
                className="text-4xl sm:text-5xl md:text-7xl font-bold mb-6 leading-tight text-white"
              >
                {/* <RadialGradient
            ...
            >
              ...
              <div className="relative max-w-3xl mx-auto">
                ...
                <div className="p-4 bg-white rounded-xl shadow-2xl max-w-2xl mx-auto"> {/* Added max-w-2xl and mx-auto */}
                  {/* Buy/Rent Toggle */}
                  ...
                  <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2 text-xs">
                    <div className="flex items-center space-x-1 p-1 bg-gray-100 rounded-lg">
                      <button className="px-2 py-1 bg-orange-100 text-orange-700 rounded-md">All</button> {/* Increased py-0.5 to py-1 */}
                      <button className="px-2 py-1 text-gray-600 hover:bg-gray-200 rounded-md">Ready</button> {/* Increased py-0.5 to py-1 */}
                      <button className="px-2 py-1 text-gray-600 hover:bg-gray-200 rounded-md">Off-Plan</button> {/* Increased py-0.5 to py-1 */}
                    </div>
                    <select className="p-2 border border-gray-300 rounded-lg focus:ring-1 focus:ring-orange-500 focus:border-transparent outline-none bg-white text-xs"> {/* Changed p-1.5 to p-2 */}
                  ...
                  <div className="mt-4 text-center"> {/* Adjusted margin from mt-6 to mt-4 */}
                    <p className="text-xs text-gray-600"> {/* Adjusted text size to xs */}
